...
-- ---
drop view demo_stemi_rm cascade; 
create view demo_stemi_rm as
...
----Join demo + weight
drop view demo_weigth_stemi_rm;
create view demo_weigth_stemi_rm as
...
\copy (SELECT * FROM demo_weigth_stemi_rm) to '/tmp/demo_weigth_stemi_rm.csv' CSV HEADER;
