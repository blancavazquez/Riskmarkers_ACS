...
-- Code for obtaining the label in stemi patients: ICUSTAY_EXPIRE_FLAG
-- ---
drop view label_stemi_rm cascade;
create view label_stemi_rm as
  SELECT
  e.subject_id
  ,e.hadm_id
  ,e.icustay_id
...
\copy (SELECT * FROM label_stemi_rm) to '/tmp/label_stemi_rm.csv' CSV HEADER;