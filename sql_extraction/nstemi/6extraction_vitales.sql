...
DROP MATERIALIZED VIEW IF EXISTS vitals_nstemi CASCADE;
create materialized view vitals_nstemi as
...
--------------
drop view vitals_nstemi2;
create view vitals_nstemi2 as
...
\copy (SELECT * FROM vitals_nstemi2) to '/tmp/vitals_nstemi2.csv' CSV HEADER;
