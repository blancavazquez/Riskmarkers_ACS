...
drop view lab_nstemi cascade;
create view lab_nstemi as
select
  e.subject_id
  ,e.hadm_id
  ,e.icustay_id
...
-----------------
drop view lab_nstemi2 cascade;
create view lab_nstemi2 as
select
  ce.subject_id
  ,ce.hadm_id
  ,ce.icustay_id
...
\copy (SELECT * FROM lab_nstemi2) to '/tmp/lab_nstemi2.csv' CSV HEADER;
